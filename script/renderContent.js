export function RenderContent(){
  ...
  const homeSection = document.querySelector('#home-section').innerHTML = homeHTML;
   ...
   const aboutDetails = {
    myPhoto: 'profile.jpg',
    aboutMeFirstPrgrph: `Xin chào! Tôi là Trần Ngọc Lan Phương, một TikToker và lập trình viên thích chia sẻ công việc sáng tạo và truyền cảm hứng. Tôi tạo nội dung có các đầu ra lập trình dễ thương của mình, biến mã phức tạp thành các dự án hấp dẫn về mặt thị giác và thú vị, tạo được tiếng vang với khán giả của tôi.`,
    aboutMeSecondPrgrph: `Ngoài TikTok, tôi còn thiết kế hình nền dựa trên mã và xây dựng các trang web danh mục đầu tư độc đáo thể hiện các kỹ năng kỹ thuật và nét nghệ thuật của tôi. Thông qua công việc của mình, tôi hướng đến mục tiêu kết hợp sự sáng tạo và chức năng, truyền cảm hứng cho những người khác nhìn thấy vẻ đẹp trong lập trình.`
   }
